# ECHO Network Metadata Completion
...
Old ECHO could see no embedded title/artist/cover yet, assume none existed, and let filename guesses or network data win. ECHO stores readiness separately from values:
