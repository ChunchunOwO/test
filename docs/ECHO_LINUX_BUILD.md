...
这份文档是 ECHO 的 Linux x64 打包、验收和故障定位指南。目标不是“能跑一下命令”，而是把 Linux 包从环境准备、FFmpeg、ALSA、native host、electron-builder 到发布前验收都讲清楚。
...
```text
build.linux.icon = build-resources/icons/echo-app-icon.png
