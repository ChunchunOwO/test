{
  description = "ECHO source-available desktop music player";
  ...
  outputs =
    ...
    in
    {
      overlays.default = final: _: {
        echo = final.callPackage ./package.nix { };
      };

      packages = forAllSystems (pkgs: {
        echo = pkgs.callPackage ./package.nix { };
        default = self.packages.${pkgs.stdenv.hostPlatform.system}.echo;
      });
