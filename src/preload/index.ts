...
import { createAppApi, createDesktopLyricsApi, createMiniPlayerApi, createPetApi, createLibraryApi, createLibraryLabApi, createPlaybackApi, type PlaybackDeps, createRemoteSourcesApi, createConnectApi, createLyricsApi, createHqPlayerApi, createAudioApi, createEqApi,
  createSleepTimerApi, createDiagnosticsApi,
  ...
  createMqttIntegrationApi, createWorkshopApi } from './ipc';
import { createSteamApi } from './ipc/steamApi';
...
const echoApi: EchoApi = {
  steam: createSteamApi(ipcRenderer, IpcChannels),
  ...
  streaming: null as never, lyrics: createLyricsApi(ipcRenderer, IpcChannels),
  mv: null as never,
  ...
  diagnostics: createDiagnosticsApi(ipcRenderer, IpcChannels, webFrame), downloads: null as never,
  accounts: null as never,
  spotify: null as never, smtc: createSmtcApi(ipcRenderer, IpcChannels), audioCd: createAudioCdApi(ipcRenderer, IpcChannels), sleepTimer: createSleepTimerApi(ipcRenderer, IpcChannels),
