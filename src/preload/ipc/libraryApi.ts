...
export function createLibraryApi(
  ...
  return {
    ...
    getGenres: (query) => ipcRenderer.invoke(IpcChannels.LibraryGetGenres, query),
    getGenre: (genreKey, query) => ipcRenderer.invoke(IpcChannels.LibraryGetGenre, genreKey, query),
    getGenreTracks: (genreKey, query) => ipcRenderer.invoke(IpcChannels.LibraryGetGenreTracks, genreKey, query),
    getGenreAlbums: (genreKey, query) => ipcRenderer.invoke(IpcChannels.LibraryGetGenreAlbums, genreKey, query),
    ...
    refreshAlbumGroupingPlaybackSafe: (request) =>
      ipcRenderer.invoke(IpcChannels.LibraryRefreshAlbumGroupingPlaybackSafe, request),
    ...
    measureTrackBpm: (trackId) => ipcRenderer.invoke(IpcChannels.LibraryMeasureTrackBpm, trackId),
