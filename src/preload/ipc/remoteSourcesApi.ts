...
export function createRemoteSourcesApi(
  ...
  return {
    ...
    selectMountedRoot: (provider) => ipcRenderer.invoke(IpcChannels.RemoteSourcesSelectMountedRoot, provider),
    authorizeZConnect: (baseUrl) => ipcRenderer.invoke(IpcChannels.RemoteSourcesAuthorizeZConnect, baseUrl),
  };
}
