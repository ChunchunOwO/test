...
import type { AirPlayReceiverStatus, ConnectDevice, ConnectPreflightResult, ConnectReceiverStatus, ConnectSessionStatus, ConnectStartRequest } from '../shared/types/connect';
import type {
  EchoLinkBasicStatus,
...
import type {
  ...
  SteamListenTogetherProbeSnapshot,
...
import type {
  ...
  LibraryScanStatus,
  LibraryScanMode,
  LibraryAlbumGroupingRefreshRequest,
...
import type {
  WorkshopActiveThemeBackground,
  WorkshopActiveVisualizerPreset,
  WorkshopBrowsePage,
...
export type DroppedFileImportResult = {
  ...
  folderScanStatuses: LibraryScanStatus[];
...
export type EchoApi = {
  steam: {
    ...
    getCloudSettingsStatus: () => Promise<SteamCloudSettingsStatus>;
    uploadCloudSettings: () => Promise<SteamCloudSettingsUploadResult>;
    downloadCloudSettings: () => Promise<SteamCloudSettingsDownloadResult>;
    getListeningStatsStatus: () => Promise<SteamListeningStatsStatus>;
    setListeningStatsEnabled: (enabled: boolean) => Promise<SteamListeningStatsStatus>;
    syncListeningStats: () => Promise<SteamListeningStatsStatus>;
    getListenTogetherProbeStatus: () => Promise<SteamListenTogetherProbeSnapshot>;
    createListenTogetherProbeRoom: () => Promise<SteamListenTogetherProbeSnapshot>;
    joinListenTogetherProbeRoom: (lobbyId: string) => Promise<SteamListenTogetherProbeSnapshot>;
    openListenTogetherProbeInvite: () => Promise<SteamListenTogetherProbeSnapshot>;
    leaveListenTogetherProbeRoom: () => Promise<SteamListenTogetherProbeSnapshot>;
    getListenTogetherStatus: () => Promise<SteamListenTogetherSnapshot>;
    createListenTogetherRoom: () => Promise<SteamListenTogetherSnapshot>;
    joinListenTogetherRoom: (lobbyId: string) => Promise<SteamListenTogetherSnapshot>;
    openListenTogetherInvite: () => Promise<SteamListenTogetherSnapshot>;
    leaveListenTogetherRoom: () => Promise<SteamListenTogetherSnapshot>;
    sendListenTogetherReaction: (reaction: SteamListenTogetherReactionId) => Promise<SteamListenTogetherSnapshot>;
    requestListenTogetherSync: () => Promise<SteamListenTogetherSnapshot>;
    getLeaderboardStatus: () => Promise<SteamLeaderboardStatus>;
    setLeaderboardsEnabled: (enabled: boolean) => Promise<SteamLeaderboardStatus>;
    syncLeaderboards: () => Promise<SteamLeaderboardStatus>;
  ...
  workshop: {
    getSnapshot: () => Promise<WorkshopManagerSnapshot>;
    getPlugins: () => Promise<WorkshopPluginSnapshot>;
    createAuthoringProject: (request: WorkshopAuthoringCreateRequest) => Promise<WorkshopAuthoringDraft | null>;
    openAuthoringProject: () => Promise<WorkshopAuthoringDraft | null>;
    validateAuthoringDraft: (request: WorkshopAuthoringDraftInput) => Promise<WorkshopAuthoringValidation>;
    saveAuthoringDraft: (request: WorkshopAuthoringSaveRequest) => Promise<WorkshopAuthoringDraft>;
    prepareAuthoringProject: (rootDirectory: string) => Promise<WorkshopAuthoringPreparedSummary>;
    openAuthoringPreview: (rootDirectory: string) => Promise<void>;
    openAuthoringFolder: (rootDirectory: string) => Promise<void>;
    publishAuthoringProject: (request: WorkshopAuthoringPublishRequest) => Promise<WorkshopAuthoringPublishResult>;
    copyAuthoringSdk: () => Promise<WorkshopAuthoringSdkCopyResult | null>;
    getSdkDescriptor: () => Promise<WorkshopSdkDescriptor>;
    runAcceptance: (request: WorkshopAcceptanceRequest) => Promise<WorkshopAcceptanceResult>;
    rollback: (request: WorkshopManagerItemRequest) => Promise<WorkshopRollbackResult>;
    previewMaintenanceCleanup: () => Promise<WorkshopMaintenancePreview>;
    runMaintenanceCleanup: (token: string) => Promise<WorkshopMaintenanceCleanupResult>;
    exportCustomizationProfile: (profile: WorkshopCustomizationProfile) => Promise<string | null>;
    importCustomizationProfile: () => Promise<WorkshopCustomizationProfile | null>;
    getPluginShareInfo: (request: WorkshopPluginRuntimeRequest) => Promise<WorkshopPlaybackShareInfo>;
    sharePluginCurrentTrack: (request: WorkshopPlaybackShareStartRequest) => Promise<WorkshopPlaybackShareTask>;
    getPluginShareTask: (request: WorkshopPlaybackShareTaskRequest) => Promise<WorkshopPlaybackShareTask>;
    requestPluginNetwork: (request: WorkshopPluginNetworkRequest) => Promise<WorkshopPluginNetworkResponse>;
    reconcile: () => Promise<WorkshopManagerActionResult>;
    requestDownload: (request: WorkshopManagerItemRequest) => Promise<WorkshopManagerActionResult>;
    ingest: (request: WorkshopManagerItemRequest) => Promise<WorkshopManagerActionResult>;
    enable: (request: WorkshopManagerItemRequest) => Promise<WorkshopManagerActionResult>;
    disable: (request: WorkshopManagerItemRequest) => Promise<WorkshopManagerActionResult>;
    apply: (request: WorkshopManagerItemRequest) => Promise<WorkshopManagerActionResult>;
    use: (request: WorkshopManagerItemRequest) => Promise<WorkshopManagerActionResult>;
    browse: (request: WorkshopBrowseRequest) => Promise<WorkshopBrowsePage>;
    subscribe: (request: WorkshopManagerItemRequest) => Promise<WorkshopManagerActionResult>;
    unsubscribe: (request: WorkshopManagerItemRequest) => Promise<WorkshopManagerActionResult>;
    openInSteam: (request: WorkshopManagerItemRequest) => Promise<WorkshopManagerActionResult>;
    getActiveLyricsScene: () => Promise<WorkshopActiveLyricsScene | null>;
    clearActiveLyricsScene: () => Promise<boolean>;
    onActiveLyricsSceneChanged: (handler: (scene: WorkshopActiveLyricsScene | null) => void) => () => void;
    getActiveVisualizerPreset: () => Promise<WorkshopActiveVisualizerPreset | null>;
    onActiveVisualizerPresetChanged: (handler: (preset: WorkshopActiveVisualizerPreset | null) => void) => () => void;
    getActiveThemeBackground: () => Promise<WorkshopActiveThemeBackground | null>;
    onActiveThemeBackgroundChanged: (handler: (background: WorkshopActiveThemeBackground | null) => void) => () => void;
    setLyricsSpectrumActive: (active: boolean) => Promise<boolean>;
    setPluginSpectrumActive: (active: boolean) => Promise<boolean>;
    setUiRuntimeActive: (active: boolean) => Promise<void>;
    onUiRuntimeEmergencyExit: (handler: () => void) => () => void;
  };
  app: {
    ...
    onMinimizedChange: (handler: (isMinimized: boolean) => void) => () => void;
    onHiddenChange: (handler: (isHidden: boolean) => void) => () => void;
    ...
    onSharedSettingsChanged: (handler: () => void) => () => void;
  ...
  library: {
    ...
    getGenres: (query?: LibraryPageQuery) => Promise<LibraryPage<LibraryGenre>>;
    getGenre: (genreKey: string, query?: LibraryPageQuery) => Promise<LibraryGenre | null>;
    getGenreTracks: (genreKey: string, query?: LibraryPageQuery) => Promise<LibraryPage<LibraryTrack>>;
    getGenreAlbums: (genreKey: string, query?: LibraryPageQuery) => Promise<LibraryPage<LibraryAlbum>>;
    ...
    refreshAlbumGroupingPlaybackSafe: (
      request?: LibraryAlbumGroupingRefreshRequest,
    ) => Promise<LibraryAlbumGroupingRefreshResult>;
    ...
    measureTrackBpm: (trackId: string) => Promise<BpmAnalysisResult>;
  ...
  playback: {
    ...
    configureAutomix: (options?: PlaybackAutomixOptions) => Promise<PlaybackStatus>;
  ...
  remoteSources: {
    ...
    createStreamUrl: (input: { trackId: string }) => Promise<RemoteStreamUrlResult>;
    ...
    selectMountedRoot: (provider: 'smb' | 'sshfs') => Promise<RemoteMountedRootGrant | null>;
    authorizeZConnect: (baseUrl: string) => Promise<RemoteWebAuthorizationResult>;
  };
  connect: {
    ...
    preflight?: (request: ConnectStartRequest) => Promise<ConnectPreflightResult>;
  ...
  diagnostics: {
    ...
    releaseUnusedRendererMemory?: () => boolean;
  ...
  eq: {
    ...
    setAnalyzerActive: (enabled: boolean) => Promise<boolean>;
    ...
    onCompressorTelemetry: (handler: (telemetry: CompressorTelemetry) => void) => () => void;
  ...
  echoLink: {
    ...
    startPairing: (host?: string) => Promise<EchoLinkPairingSession>;
