const coverIntelligenceEnabledStorageKey = 'echo.cover-intelligence.enabled';
const coverIntelligenceCacheStorageKey = 'echo.cover-intelligence.cache.v1';
...
const loadCoverPixels = (
  ...
  new Promise((resolve, reject) => {
    ...
    abortHandler = (): void => fail(new DOMException('Cover analysis was aborted.', 'AbortError'));
    ...
    timeout = window.setTimeout(
      () => fail(new Error('Cover analysis timed out.')),
    ...
    image.onerror = () => fail(new Error('Cover image could not be loaded.'));
    image.src = src;
  });
