import type { CommunityWorkshopTranslationKey } from './locales/communityWorkshopFamily';
...
type AlbumDetailTranslationKey =
  ...
  | 'albumDetail.tracks.disc'
  | 'albumDetail.tracks.discUnknown'
  ...
  | 'albumDetail.tracks.sort.aria'
  | 'albumDetail.tracks.sort.default'
  | 'albumDetail.tracks.sort.filename'
...
type ArtistDetailTranslationKey =
  ...
  | 'artistDetail.events.openDetails'
  | 'artistDetail.events.providerKeysRequired'
  | 'artistDetail.events.timePending'
  | 'artistDetail.events.unavailable'
  | 'artistDetail.events.venuePending'
  | 'artistDetail.fact.albums'
  | 'artistDetail.fact.duration'
...
type GenreDetailTranslationKey =
  | 'genreDetail.action.addToQueue'
  | 'genreDetail.action.back'
  | 'genreDetail.action.play'
  | 'genreDetail.action.shuffle'
  | 'genreDetail.albums.aria'
  | 'genreDetail.albums.count'
  | 'genreDetail.albums.empty'
  | 'genreDetail.albums.error.desktopBridge'
  | 'genreDetail.albums.heading'
  | 'genreDetail.albums.loadedCount'
  | 'genreDetail.aria.details'
  | 'genreDetail.aria.mosaic'
  | 'genreDetail.error.desktopBridgeRead'
  | 'genreDetail.label.genre'
  | 'genreDetail.meta.albums'
  | 'genreDetail.meta.tracks'
  | 'genreDetail.tab.albums'
  | 'genreDetail.tab.tracks'
  | 'genreDetail.tracks.column.album'
  | 'genreDetail.tracks.empty'
  | 'genreDetail.tracks.heading'
  | 'genreDetail.tracks.loading'
  | 'genreDetail.tracks.unknownAlbum';
...
export type TranslationKey =
  ...
  | 'app.titlebar.settingsBack'
  | 'app.titlebar.settingsBackHint'
  | 'app.window.minimize'
  ...
  | 'connectPage.devices.chooseSource'
  | 'connectPage.devices.clearSearch'
  | 'connectPage.devices.collapse'
  | 'connectPage.devices.empty'
  | 'connectPage.devices.emptyHint'
  | 'connectPage.devices.expand'
  | 'connectPage.devices.details'
  | 'connectPage.devices.disconnect'
  | 'connectPage.devices.hide'
  | 'connectPage.devices.hiddenAria'
  | 'connectPage.devices.hiddenTitle'
  | 'connectPage.devices.filterActive'
  | 'connectPage.devices.filterAll'
  | 'connectPage.devices.filterAria'
  | 'connectPage.devices.filterAttention'
  | 'connectPage.devices.filterReady'
  | 'connectPage.devices.kicker'
  | 'connectPage.devices.pin'
  | 'connectPage.devices.restoreAll'
  | 'connectPage.devices.restoreHint'
  | 'connectPage.devices.searchEmpty'
  | 'connectPage.devices.searchEmptyHint'
  | 'connectPage.devices.searchInput'
  | 'connectPage.devices.searchPlaceholder'
  | 'connectPage.devices.searchResults'
  | 'connectPage.devices.refresh'
  | 'connectPage.devices.refreshing'
  | 'connectPage.devices.sourceRequired'
  | 'connectPage.devices.sourceRequiredHint'
  | 'connectPage.devices.switchSourceRequired'
  | 'connectPage.devices.switchSourceRequiredHint'
  | 'connectPage.devices.summary'
  | 'connectPage.devices.unpin'
  | 'connectPage.devices.streamerLabel'
  | 'connectPage.devices.title'
  | 'connectPage.header.autoStart'
  | 'connectPage.header.description'
  | 'connectPage.header.descriptionMobile'
  | 'connectPage.header.descriptionRadio'
  | 'connectPage.header.descriptionReceive'
  | 'connectPage.header.descriptionHqPlayer'
  | 'connectPage.header.kicker'
  | 'connectPage.brand.subtitle'
  | 'connectPage.rail.output'
  | 'connectPage.rail.hqplayer'
  | 'connectPage.rail.receive'
  | 'connectPage.rail.mobile'
  | 'connectPage.rail.radio'
  | 'connectPage.rail.groupCast'
  | 'connectPage.rail.groupIncoming'
  | 'connectPage.header.refresh'
  | 'connectPage.error.dismiss'
  | 'connectPage.hqplayer.enable'
  | 'connectPage.hqplayer.disable'
  | 'connectPage.hqplayer.aria'
  | 'connectPage.hqplayer.guideTitle'
  | 'connectPage.hqplayer.guide1'
  | 'connectPage.hqplayer.guide2'
  | 'connectPage.hqplayer.guide3'
  | 'connectPage.hqplayer.listeningHint'
  | 'connectPage.hqplayer.offlineHint'
  | 'connectPage.hqplayer.playbackAria'
  | 'connectPage.hqplayer.playbackTitle'
  | 'connectPage.hqplayer.waitingTitle'
  | 'connectPage.hqplayer.progressAria'
  | 'connectPage.hqplayer.debugTitle'
  | 'connectPage.hqplayer.debugEmpty'
  | 'connectPage.hqplayer.debugNoneYet'
  | 'connectPage.hqplayer.field.host'
  | 'connectPage.hqplayer.field.product'
  | 'connectPage.hqplayer.field.engine'
  | 'connectPage.hqplayer.field.profile'
  | 'connectPage.hqplayer.field.handoff'
  | 'connectPage.hqplayer.field.control'
  | 'connectPage.hqplayer.field.send'
  | 'connectPage.hqplayer.field.source'
  | 'connectPage.hqplayer.field.track'
  | 'connectPage.hqplayer.field.headers'
  | 'connectPage.hqplayer.field.mediaUrl'
  ...
  | 'connectPage.output.field.target'
  | 'connectPage.output.field.device'
  | 'connectPage.output.field.signal'
  | 'connectPage.output.guideTitle'
  | 'connectPage.output.guide1'
  | 'connectPage.output.guide2'
  | 'connectPage.output.guide3'
  | 'connectPage.output.localHint'
  | 'connectPage.output.liveHint'
  | 'connectPage.preflight.blocked'
  | 'connectPage.preflight.cancel'
  | 'connectPage.preflight.checking'
  | 'connectPage.preflight.checkingHint'
  | 'connectPage.preflight.confirm'
  | 'connectPage.preflight.controls'
  | 'connectPage.preflight.controlsLimited'
  | 'connectPage.preflight.controlsReady'
  | 'connectPage.preflight.delivery'
  | 'connectPage.preflight.description'
  | 'connectPage.preflight.device'
  | 'connectPage.preflight.deviceBlocked'
  | 'connectPage.preflight.deviceReady'
  | 'connectPage.preflight.direct'
  | 'connectPage.preflight.eyebrow'
  | 'connectPage.preflight.hqplayer'
  | 'connectPage.preflight.source'
  | 'connectPage.preflight.sourceBlocked'
  | 'connectPage.preflight.sourceReady'
  | 'connectPage.preflight.title'
  | 'connectPage.preflight.transcode'
  | 'connectPage.tabs.mobile'
  | 'connectPage.tabs.aria'
  | 'connectPage.tabs.output'
  | 'connectPage.tabs.hqplayer'
  | 'connectPage.tabs.radio'
  | 'connectPage.tabs.receive'
  | 'connectPage.trust.copied'
  | 'connectPage.trust.connectingDetail'
  | 'connectPage.trust.connectingTitle'
  | 'connectPage.trust.copyDiagnostics'
  | 'connectPage.trust.device'
  | 'connectPage.trust.externalDetail'
  | 'connectPage.trust.externalTitle'
  | 'connectPage.trust.eyebrow'
  | 'connectPage.trust.failedDetail'
  | 'connectPage.trust.failedTitle'
  | 'connectPage.trust.localDetail'
  | 'connectPage.trust.localTitle'
  | 'connectPage.trust.retry'
  | 'connectPage.trust.returnLocal'
  ...
  | 'connectPage.receiver.protocol'
  | 'connectPage.receiver.field.state'
  | 'connectPage.receiver.field.name'
  | 'connectPage.receiver.field.network'
  | 'connectPage.receiver.field.source'
  | 'connectPage.receiver.guideTitle'
  | 'connectPage.receiver.guide1'
  | 'connectPage.receiver.guide2'
  | 'connectPage.receiver.guide3'
  | 'connectPage.receiver.offlineHint'
  | 'connectPage.receiver.listeningHint'
  ...
  | 'connectPage.radio.playClipboard'
  ...
  | 'connectPage.airplay.protocolLabel'
  | 'connectPage.airplay.field.protocol'
  | 'connectPage.airplay.field.backend'
  | 'connectPage.airplay.guideTitle'
  | 'connectPage.airplay.guide1'
  | 'connectPage.airplay.guide2'
  | 'connectPage.airplay.guide3'
  | 'connectPage.airplay.offlineHint'
  | 'connectPage.airplay.listeningHint'
  | 'firstRun.library.chooseFolder'
  | 'firstRun.library.noneSelected'
  | 'firstRun.library.scanAfterFinish'
  | 'firstRun.mascot.basics'
  | 'firstRun.mascot.library'
  | 'firstRun.mascot.personalize'
  | 'firstRun.mascot.playback'
  | 'firstRun.mascot.summary'
  ...
  | 'audioDrawer.deviceRefresh.failed'
  | 'audioDrawer.deviceRefresh.refreshing'
  | 'audioDrawer.deviceRefresh.success'
  ...
  | 'library.artists.grouping.albumArtist'
  | 'library.artists.grouping.albumArtistHint'
  ...
  | 'library.artists.sort.albumCountDesc'
  | 'library.artists.sort.frequent'
  | 'library.artists.sort.group.view'
  | 'library.artists.sort.nameAsc'
  | 'library.artists.sort.nameDesc'
  | 'library.artists.title'
  | 'library.genres.error.desktopBridge'
  | 'library.genres.empty'
  | 'library.genres.listAria'
  | 'library.genres.loading'
  | 'library.genres.meta.albums'
  | 'library.genres.meta.noTracks'
  | 'library.genres.meta.tracks'
  | 'library.genres.searchPlaceholder'
  | 'library.genres.sort.aria'
  | 'library.genres.sort.frequent'
  | 'library.genres.sort.nameAsc'
  | 'library.genres.sort.nameDesc'
  | 'library.genres.title'
  | 'library.genres.unclassified'
  | 'library.count.total'
  ...
  | 'folders.filters.currentFolder'
  | 'folders.filters.label'
  | 'folders.filters.scopeLabel'
  ...
  | 'notice.audioDeviceNotFoundFallback'
  ...
  | 'route.connect.label'
  | 'route.community.description'
  | 'route.community.label'
  | 'route.workshop.description'
  | 'route.workshop.label'
  ...
  | 'historyPage.summary.year.count'
  | 'historyPage.summary.year.duration'
  | 'historyPage.summary.year.group'
  | 'historyPage.summary.year.latest'
  | 'historyPage.summary.year.tracks'
  | 'historyPage.insights.aria'
  | 'historyPage.insights.title'
  | 'historyPage.insights.comparison.title'
  | 'historyPage.insights.comparison.plays'
  | 'historyPage.insights.comparison.duration'
  | 'historyPage.insights.comparison.tracks'
  | 'historyPage.insights.comparison.unavailable'
  | 'historyPage.insights.sessions.title'
  | 'historyPage.insights.sessions.count'
  | 'historyPage.insights.sessions.average'
  | 'historyPage.insights.sessions.longest'
  | 'historyPage.insights.sessions.streak'
  | 'historyPage.insights.discovery.title'
  | 'historyPage.insights.discovery.new'
  | 'historyPage.insights.discovery.unique'
  | 'historyPage.insights.discovery.returning'
  | 'historyPage.insights.discovery.replayed'
  | 'historyPage.insights.discovery.rediscovered'
  | 'historyPage.insights.discovery.repeatRate'
  | 'historyPage.insights.days'
  ...
  | 'lyricsSettings.background.emptyStateEffects'
  | 'lyricsSettings.background.emptyStateEffectsDescription'
  ...
  | 'lyricsSettings.visual.themeFilter'
  | 'lyricsSettings.visual.themeFilterDescription'
  | 'lyricsSettings.visual.pageStyleEditorial'
  | 'lyricsSettings.visual.pageStyleFolded'
  | 'lyricsSettings.visual.pageStyleRoseVinyl'
  | 'lyricsSettings.visual.pageStyleCinemaStage'
  | 'lyricsSettings.visual.pageStyleKineticPoster'
  | 'lyricsSettings.visual.pageStyleCoverStage'
  | 'lyricsSettings.visual.pageStyleCutBoard'
  | 'lyricsSettings.visual.roseVinylBackgroundBlur'
  | 'lyricsSettings.visual.roseVinylBackgroundBlurDescription'
  | 'lyricsSettings.visual.roseVinylGradient'
  | 'lyricsSettings.visual.roseVinylGradientDescription'
  ...
  | 'lyricsSettings.engine.sourceLocal'
  | 'lyricsSettings.engine.sourceNetwork'
  | 'lyricsSettings.engine.sourceSummary'
  | 'lyricsSettings.engine.threshold'
  | 'lyricsSettings.engine.title'
  | 'lyricsSettings.engine.wordTiming'
  | 'lyricsSettings.engine.wordTiming.estimated'
  | 'lyricsSettings.engine.wordTiming.source'
  | 'lyricsSettings.engine.wordTiming.unavailable'
  | 'lyricsSettings.engine.wordTiming.unsupported'
  ...
  | 'lyricsSettings.provider.subsonic'
  ...
  | 'songs.filter.audioFormat.aac'
  | 'songs.filter.audioFormat.aiff'
  | 'songs.filter.audioFormat.alac'
  | 'songs.filter.audioFormat.all'
  | 'songs.filter.audioFormat.dsd'
  | 'songs.filter.audioFormat.flac'
  | 'songs.filter.audioFormat.mp3'
  | 'songs.filter.audioFormat.ogg'
  | 'songs.filter.audioFormat.opus'
  | 'songs.filter.audioFormat.other'
  ...
  | 'songs.filter.audioFormat.wav'
  | 'songs.filter.button'
  | 'songs.filter.menuAria'
  | 'songs.filter.sampleRate'
  | 'songs.filter.sampleRate.all'
  ...
  | 'settings.appearance.themePreset.celadonPorcelain'
  | 'settings.appearance.themePreset.celadonPorcelain.description'
  | 'settings.appearance.themePreset.polarDaybreak'
  | 'settings.appearance.themePreset.polarDaybreak.description'
  | 'settings.appearance.themePreset.plumVelvet'
  | 'settings.appearance.themePreset.plumVelvet.description'
  | 'settings.appearance.themePreset.midnightCopper'
  | 'settings.appearance.themePreset.midnightCopper.description'
  | 'settings.appearance.themePreset.taroBunny'
  | 'settings.appearance.themePreset.taroBunny.description'
  | 'settings.appearance.themePreset.milkTeaBear'
  | 'settings.appearance.themePreset.milkTeaBear.description'
  | 'settings.appearance.themePreset.ramuneGlass'
  | 'settings.appearance.themePreset.ramuneGlass.description'
  | 'settings.appearance.themePreset.pistachioMousse'
  | 'settings.appearance.themePreset.pistachioMousse.description'
  | 'settings.appearance.themePreset.sakuraWagashi'
  | 'settings.appearance.themePreset.sakuraWagashi.description'
  | 'settings.appearance.themePreset.kamakuraHydrangea'
  | 'settings.appearance.themePreset.kamakuraHydrangea.description'
  | 'settings.appearance.themePreset.ruriKintsugi'
  | 'settings.appearance.themePreset.ruriKintsugi.description'
  | 'settings.appearance.themePreset.hinokiRyokan'
  | 'settings.appearance.themePreset.hinokiRyokan.description'
  | 'settings.appearance.themePreset.nightGlass'
  | 'settings.appearance.themePreset.nightGlass.description'
  | 'settings.appearance.themePreset.boneIron'
  | 'settings.appearance.themePreset.boneIron.description'
  | 'settings.appearance.themePreset.harborLamp'
  | 'settings.appearance.themePreset.harborLamp.description'
  | 'settings.appearance.themePreset.ashRose'
  | 'settings.appearance.themePreset.ashRose.description'
  ...
  | 'settings.general.settingsHideSidebar.description'
  | 'settings.general.settingsHideSidebar.title'
  ...
  | 'settings.eq.action.exportPreset'
  ...
  | 'settings.eq.curve.addFilterHint'
  | 'settings.eq.curve.dragBand'
  | 'settings.eq.curve.dragHint'
  | 'settings.eq.curve.bandSetting'
  | 'settings.eq.curve.totalResponse'
  | 'settings.eq.curve.fineEdit'
  | 'settings.eq.curve.freeFrequency'
  | 'settings.eq.curve.lockedFrequency'
  ...
  | 'settings.eq.proEditor.advanced'
  | 'settings.eq.proEditor.amount'
  | 'settings.eq.proEditor.dragHelp'
  | 'settings.eq.proEditor.position'
  | 'settings.eq.proEditor.presetTools'
  | 'settings.eq.proEditor.range'
  | 'settings.eq.proEditor.rangeHelp'
  | 'settings.eq.proEditor.selected'
  ...
  | 'settings.eq.preset.name.acoustic-silk'
  | 'settings.eq.preset.name.anime-jpop'
  | 'settings.eq.preset.name.bass-boost'
  | 'settings.eq.preset.name.bk-room-curve'
  | 'settings.eq.preset.name.broadcast-voice'
  | 'settings.eq.preset.name.cinema-orchestra'
  | 'settings.eq.preset.name.city-pop'
  | 'settings.eq.preset.name.classic-smiley'
  | 'settings.eq.preset.name.classical'
  | 'settings.eq.preset.name.diffuse-field'
  | 'settings.eq.preset.name.diffuse-field-5128'
  | 'settings.eq.preset.name.diffuse-field-gras-kemar'
  | 'settings.eq.preset.name.diffuse-field-iso-11904-1'
  | 'settings.eq.preset.name.female-vocal-air'
  | 'settings.eq.preset.name.flat'
  | 'settings.eq.preset.name.harman-in-ear'
  | 'settings.eq.preset.name.harman-in-ear-2016'
  | 'settings.eq.preset.name.harman-in-ear-2017'
  | 'settings.eq.preset.name.harman-in-ear-2019-no-bass'
  | 'settings.eq.preset.name.harman-over-ear-2013'
  | 'settings.eq.preset.name.harman-over-ear-2015'
  | 'settings.eq.preset.name.harman-over-ear-2018-no-bass'
  | 'settings.eq.preset.name.harman-speaker-room-2013'
  | 'settings.eq.preset.name.harman-target'
  | 'settings.eq.preset.name.headphone-warm'
  | 'settings.eq.preset.name.live-house'
  | 'settings.eq.preset.name.lofi-dusk'
  | 'settings.eq.preset.name.loudness'
  | 'settings.eq.preset.name.night'
  | 'settings.eq.preset.name.piano-room'
  | 'settings.eq.preset.name.rock'
  | 'settings.eq.preset.name.studio-neutral'
  | 'settings.eq.preset.name.treble-sparkle'
  | 'settings.eq.preset.name.vinyl-warmth'
  | 'settings.eq.preset.name.vocal-clear'
  ...
  | 'settings.eq.subtitle.parametric'
  | 'settings.eq.title'
  | 'settings.eq.title.parametric'
  ...
  | 'settings.nav.steamPresence.description'
  | 'settings.nav.steamPresence.label'
  | 'settings.nav.library.description'
  | 'settings.nav.library.label'
  | 'settings.nav.lyrics.description'
  ...
  | 'settings.remote.home.disconnect'
  ...
  | 'settings.remote.home.stopOpening'
  | 'settings.remote.home.stopPreview'
  ...
  | 'settings.playback.outputMode.ks'
  ...
  | 'settings.playback.stability.description'
  | 'settings.playback.stability.details'
  ...
  | 'settings.playback.stability.status.attention'
  | 'settings.playback.stability.status.idle'
  | 'settings.playback.stability.status.stable'
  | 'settings.playback.stability.summary.buffer'
  | 'settings.playback.stability.summary.output'
  | 'settings.playback.stability.summary.playback'
  | 'settings.playback.stability.summary.recovery'
  ...
  | 'settings.shortcuts.action.openSettings.description'
  | 'settings.shortcuts.action.openSettings.title'
  | 'settings.shortcuts.action.openLiked.description'
  | 'settings.shortcuts.action.openLiked.title'
  ...
  | 'settings.shortcuts.action.resetPlaybackSpeed.description'
  | 'settings.shortcuts.action.resetPlaybackSpeed.title'
  | 'settings.shortcuts.action.replayCurrentTrack.description'
  | 'settings.shortcuts.action.replayCurrentTrack.title'
  | 'settings.shortcuts.action.revealCurrentTrackInFolder.description'
  | 'settings.shortcuts.action.revealCurrentTrackInFolder.title'
  ...
  | 'settings.shortcuts.action.toggleEq.description'
  | 'settings.shortcuts.action.toggleEq.title'
  | 'settings.shortcuts.action.toggleLyrics.description'
  | 'settings.shortcuts.action.toggleLyrics.title'
  | 'settings.shortcuts.action.toggleMiniPlayer.description'
  | 'settings.shortcuts.action.toggleMiniPlayer.title'
  | 'settings.shortcuts.action.togglePet.description'
  | 'settings.shortcuts.action.togglePet.title'
  ...
  | 'settings.shortcuts.group.all'
  | 'settings.shortcuts.group.audio'
  | 'settings.shortcuts.group.collapseAll'
  | 'settings.shortcuts.group.expandAll'
  | 'settings.shortcuts.group.jumpAria'
  | 'settings.shortcuts.group.library'
  | 'settings.shortcuts.group.lyrics'
  | 'settings.shortcuts.group.meta'
  | 'settings.shortcuts.group.playback'
  | 'settings.shortcuts.group.speed'
  | 'settings.shortcuts.group.volume'
  | 'settings.shortcuts.group.windows'
  | 'settings.shortcuts.localUnavailable'
  | 'settings.shortcuts.mouse.back'
  | 'settings.shortcuts.mouse.forward'
  | 'settings.shortcuts.mouse.middle'
  ...
  | 'crashGuard.action.feedback'
  | 'crashGuard.action.feedbackTitle'
  | 'crashGuard.action.restart'
  | 'crashGuard.action.restartTitle'
  | 'crashGuard.action.quit'
  | 'crashGuard.action.quitTitle'
  | 'crashGuard.summary'
  | 'crashGuard.action.copy'
  | 'crashGuard.action.copyTitle'
  | 'crashGuard.action.copied'
  | 'crashGuard.action.copyFailed'
  | 'crashGuard.action.confirmRestart'
  | 'crashGuard.action.confirmQuit'
  | 'crashGuard.group.preserve'
  | 'crashGuard.group.recover'
  | 'crashGuard.shortcut.hint'
  | 'crashGuard.key.export'
  | 'crashGuard.key.report'
  | 'crashGuard.key.copy'
  | 'crashGuard.key.reload'
  | 'crashGuard.key.confirmNote'
  ...
  | CommunityWorkshopTranslationKey;
...
export const resolveTranslationText = (
  locale: Locale,
  translations: TranslationDictionary | undefined,
  key: TranslationKey,
): string => {
  const fromLocale = translations?.[key];
  if (fromLocale) {
    return fromLocale;
  }
  ...
  return getLoadedTranslations('en-US')?.[key] ?? fallbackTranslations[key] ?? key;
};
