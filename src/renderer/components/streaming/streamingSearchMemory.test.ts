...
describe('streamingSearchMemory', () => {
  ...
  it('persists the selected streaming quality', () => {
    ...
    expect(window.localStorage.getItem('echo.streaming.quality')).toBe('hires');
