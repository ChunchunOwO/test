...
describe('SegmentLoopPanel', () => {
  it('saves the current A-B range as a per-track bookmark', () => {
    ...
    const stored = JSON.parse(window.localStorage.getItem('echo:segment-bookmarks:v1') ?? '{}') as Record<string, Array<{ title: string; startSeconds: number; endSeconds: number }>>;
