...
describe('PlayerProgress', () => {
  ...
  it('keeps dormant rainbow styling free of packaged Nyan Cat artwork', () => {
    const css = readFileSync('src/renderer/styles/theme-presets.css', 'utf8');
    ...
    expect(css).not.toContain('nyancat-thumb.png');
    expect(css).not.toContain('nyancat-rainbow.png');
    expect(css).toMatch(
