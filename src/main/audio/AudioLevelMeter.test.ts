...
describe('AudioLevelMeter', () => {
  ...
  it('uses native post-DSP spectrum telemetry when the host supplies it', () => {
    const spectrum = Array.from({ length: 32 }, (_, index) => index / 31);
    expect(createNativeAudioLevelTelemetry(-7.25, -18.75, spectrum)).toMatchObject({
