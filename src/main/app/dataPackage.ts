...
const dataPackageFormat = 'echo-data-package';
...
const createRestoreReadme = (): string => `# ECHO data package

This package is an export-only migration bundle.

What is inside:
- app/settings.json: current ECHO settings.
