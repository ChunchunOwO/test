...
(async () => {
  ...
  await applyTagsToFile(filePath, {
    ...
    composer: tags.composer === undefined ? undefined : tags.composer ?? '',
    track: tags.trackNo ?? 0,
    totalTracks: tags.totalTracks === undefined ? undefined : tags.totalTracks ?? 0,
    discNumber: tags.discNo ?? 0,
    totalDiscs: tags.totalDiscs === undefined ? undefined : tags.totalDiscs ?? 0,
    year: tags.year ?? 0,
    genre: tags.genre ?? '',
    bpm: tags.bpm === undefined ? undefined : tags.bpm ?? 0,
    comment: tags.comment === undefined ? undefined : tags.comment ?? '',
  });
