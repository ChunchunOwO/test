...
const osuDownloadUserAgent = 'ECHO/26.5 osu downloader (https://github.com/moekotori/echo)';
...
const playbackOnlyDownloadBlockedMessage = 'This streaming platform is playback-only in ECHO. Downloading this content is disabled by policy.';
