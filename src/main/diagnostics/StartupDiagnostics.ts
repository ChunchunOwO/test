...
import { getLibraryEntryPathForUserData } from '../app/editionDataSync';
...
const snapshotPersistentFile = (
  ...
  const path = name.startsWith('echo-library.sqlite')
    ? getLibraryEntryPathForUserData(userDataPath, name)
