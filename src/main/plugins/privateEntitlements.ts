...
export const getPrivatePluginOperations = (): PrivateEntitlementsProvider['plugins'] | null =>
...
export const requirePrivateFeature = async (_feature: PrivateFeatureId = 'echo-pro'): Promise<void> => undefined;
