import type {
  AutomixRuntimePhase,
  AutomixRuntimeState,
  AutomixHandoffProfileV2,
  AutomixTransitionModeV2,
} from './automix';

export type AudioOutputMode = 'shared' | 'exclusive' | 'asio' | 'ks' | 'system';
...
export type AudioSdmRuntimeStatus = {
  ...
  realtimeAdmissionRatio?: number | null;
  pcmDspSampleRate?: number | null;
  pcmDspMaximumBlockFrames?: number | null;
  peakFeedbackState?: number | null;
...
export type AudioAutomixStatus = {
  ...
  transitionMode?:
    ...
    | AutomixTransitionModeV2
    | null;
  handoffProfile?: AutomixHandoffProfileV2 | null;
  transitionStartsInSeconds?: number | null;
  fallbackReason?: string | null;
  beatAligned?: boolean;
  gapless?: boolean;
