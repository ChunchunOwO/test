...
export type PluginPanelPlacement = (typeof pluginPanelPlacements)[number];
...
export const pluginPlayerBarActionIcons = [
  'blocks',
  'sparkles',
  'bot',
  'radio',
...
export type PluginPlayerBarActionIcon = (typeof pluginPlayerBarActionIcons)[number];

export type PluginPlayerBarActionContribution = {
  id: string;
  title: string;
  commandId: string;
  description?: string;
...
export type PluginManifestContributes = {
  ...
  playerBarActions?: PluginPlayerBarActionContribution[];
